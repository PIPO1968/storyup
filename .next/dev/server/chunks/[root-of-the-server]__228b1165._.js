...
async function GET(request) {
    ...
    `);
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT * FROM premium WHERE nick = $1', [
            nick
        ]);
...
async function POST(request) {
    ...
    `);
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('INSERT INTO premium (nick, expiracion) VALUES ($1, $2) ON CONFLICT (nick) DO UPDATE SET expiracion = EXCLUDED.expiracion RETURNING *', [
            nick,
            expiracion
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__228b1165._.js.map